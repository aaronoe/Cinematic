...
package de.aaronoe.cinematic.Data.ActorCredits;
...
public class ActorCredits implements Parcelable
{
    ...
    public final static Parcelable.Creator<ActorCredits> CREATOR = new Creator<ActorCredits>() {
        ...
        public ActorCredits createFromParcel(Parcel in) {
            ...
            in.readList(instance.cast, (de.aaronoe.cinematic.Data.ActorCredits.Cast.class.getClassLoader()));
            in.readList(instance.crew, (de.aaronoe.cinematic.Data.ActorCredits.Crew.class.getClassLoader()));
