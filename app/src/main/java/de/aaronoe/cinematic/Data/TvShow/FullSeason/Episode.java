...
public class Episode implements Parcelable
{
    ...
    public final static Parcelable.Creator<Episode> CREATOR = new Creator<Episode>() {
        ...
        public Episode createFromParcel(Parcel in) {
            ...
            in.readList(instance.crew, (de.aaronoe.cinematic.Data.TvShow.FullSeason.Crew.class.getClassLoader()));
            instance.episodeNumber = ((Integer) in.readValue((Integer.class.getClassLoader())));
            in.readList(instance.guestStars, (de.aaronoe.cinematic.Data.TvShow.FullSeason.GuestStar.class.getClassLoader()));
