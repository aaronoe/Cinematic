...
public class ActorCredits implements Parcelable
{
    ...
    public final static Parcelable.Creator<ActorCredits> CREATOR = new Creator<ActorCredits>() {
        ...
        public ActorCredits createFromParcel(Parcel in) {
            ...
            in.readList(instance.cast, (de.aaronoe.cinematic.model.ActorCredits.Cast.class.getClassLoader()));
            in.readList(instance.crew, (de.aaronoe.cinematic.model.ActorCredits.Crew.class.getClassLoader()));
