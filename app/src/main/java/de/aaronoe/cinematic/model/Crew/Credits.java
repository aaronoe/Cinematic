...
public class Credits implements Parcelable
{
    ...
    public final static Parcelable.Creator<Credits> CREATOR = new Creator<Credits>() {
        ...
        public Credits createFromParcel(Parcel in) {
            ...
            in.readList(instance.cast, (de.aaronoe.cinematic.model.Crew.Cast.class.getClassLoader()));
            in.readList(instance.crew, (de.aaronoe.cinematic.model.Crew.Crew.class.getClassLoader()));
            return instance;
        }
