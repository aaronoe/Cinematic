...
public class Credits implements Parcelable
{
    ...
    public final static Parcelable.Creator<Credits> CREATOR = new Creator<Credits>() {
        ...
        public Credits createFromParcel(Parcel in) {
            ...
            in.readList(instance.cast, (de.aaronoe.popularmovies.Data.Crew.Cast.class.getClassLoader()));
            in.readList(instance.crew, (de.aaronoe.popularmovies.Data.Crew.Crew.class.getClassLoader()));
            return instance;
        }
